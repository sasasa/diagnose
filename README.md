<!--
composer create-project laravel/laravel:^8.0 test-app
docker run --rm \
    -u "$(id -u):$(id -g)" \
    -v $(pwd):/var/www/html \
    -w /var/www/html \
...
sail composer require --dev laravel-lang/lang
cp ./vendor/laravel-lang/lang/locales/ja/ja.json ./resources/lang/
